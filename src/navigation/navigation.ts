import { getBaseURI, IStringOrURL, stringOrURLToURL } from '@lifaon/rx-dom';
import { createEventListener, createMulticastSource, createNotification, freeze, INotification, IObservable } from '@lifaon/rx-js-light';
